...
- Replace `<input file>` with the full name of the text file containing the input Points, as described in the project specification. This file should be located in the root of the project.
